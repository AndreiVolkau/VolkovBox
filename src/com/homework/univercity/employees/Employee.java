...
import com.homework.univercity.Main;
import com.homework.univercity.Workable;
...
public abstract class Employee implements Workable {
	...
	public void setBirthDate(String birthDate) {
		...
		try {
			...
			throw new DateParseException("Date format is invalid, valid format is MM/dd/yyyy", e);
		}
	}
